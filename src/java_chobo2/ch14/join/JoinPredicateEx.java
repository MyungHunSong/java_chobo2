...
public class JoinPredicateEx {
	...
	private static void extradcate() {
		...
		System.out.println(notP.test(101) + ":" + notP.test(99)); // 지렷다... 질질
		...
		boolean result = pEq.test("ab");
		System.out.println(result + "다욧");
		
		result = Predicate.isEqual(str1).test(str2);
		System.out.println(result + " 팩트다");
	}
